...
{
    class MyDataObject : System.Windows.Forms.IDataObject, IComDataObject
    {
        ...
        {
            this.dataObject.SetData(format, autoConvert, data);
        }
        ...
        #endregion System.Windows.Forms.IDataObject interfaces
        ...
        {
            if (DataFormats.GetFormat(format.cfFormat).Name == "FileContents" &&
                this.fileContents is not null)
            {
        ...
        {
            var format = DataFormats.GetFormat(formatIn.cfFormat).Name;
